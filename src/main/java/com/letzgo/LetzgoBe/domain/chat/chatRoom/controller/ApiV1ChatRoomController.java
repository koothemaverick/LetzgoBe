...
public class ApiV1ChatRoomController {
    ...
    @GetMapping
    public ApiResponse<List<ChatRoomResponse>> getChatRoom(@ModelAttribute ChatRoomPage request, @LoginUser LoginUserDto loginUser){
    ...
    public ApiResponse<Void> leaveChatRoom(@PathVariable("chatRoomId") Long chatRoomId, @LoginUser LoginUserDto loginUser){
