...
public class CommentServiceImpl implements CommentService {
    ...
    @Override
    @Transactional
    public void addComment(Long postId, @Valid CommentForm commentForm, LoginUserDto loginUser){
    ...
    @Override
    @Transactional
    public void updateComment(Long commentId, @Valid CommentForm commentForm, LoginUserDto loginUser){
        Comment comment = commentRepository.findById(commentId).orElseThrow(() -> new ServiceException(ReturnCode.COMMENT_NOT_FOUND));
